...
export const lessons: TraceLessonConfig[] = [
  ...
  makeLesson('y', 23, 'yellow',
    [{ id: 'cursive-capital', path: 'M16 25 C25 15 37 11 42 17 C49 25 42 39 37 48 C33 55 36 51 44 51 C56 51 72 35 84 17 C74 40 63 62 51 78 C43 90 32 92 22 88 C17 86 13 82 11 79' }],
    [{ id: 'cursive-lowercase', path: 'M35 38 C34 52 28 66 25 76 C22 83 27 89 36 89 C49 89 68 63 82 38 C73 59 63 76 49 90 C41 97 32 100 26 96 C20 92 22 84 29 80 C38 76 48 86 58 84 C68 82 75 72 80 64' }]),
